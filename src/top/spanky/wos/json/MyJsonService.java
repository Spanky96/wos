...
public class MyJsonService {
    ...
    private JSONObject shopBasicJsonObj;

    public JSONObject getShopBasicInfo() {
        if (shopBasicJsonObj == null) {
            ...
            shopBasicJsonObj = JSONObject.fromObject(buffer.toString());
        }
        return shopBasicJsonObj;
    }
    ...
    public boolean setBasicInfoJsonFile(JSONObject jsonObject) {
        ...
        try {
            ...
            this.shopBasicJsonObj = jsonObject;
            return true;
        } catch (IOException e) {
